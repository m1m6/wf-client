...
import InviteHelperModal from '../invite/components/InviteHelperModal';
import InviteByEmail from '../invite/components/InviteByEmail';
        ...
        <div className="campaign-view">
            <div className="header">
                <div className="invitation">
                    ...
                    <div className="pointer underline" onClick={() => setHelperModalVisible(true)}>
                        How do invitation work?
                    </div>
                </div>
            ...
            <div className="overview">
                ...
                <div className="influencers-summary">
                    ...
                    <ProfilesList allProfiles={allProfiles} campaignId={campaignId} />
                </div>
            </div>
            ...
            {helperModalVisible && (
                <InviteHelperModal
                    ...
                    setHelperModalVisible={setHelperModalVisible}
                />
            )}
        </div>
    );
...
const ProfilesList = ({ allProfiles, campaignId }) => {
    const [inviteByEmailModalVisible, setInviteByEmailModalVisible] = useState(false);
        ...
        <div class="influencers">
            {allProfiles.length > 0 &&
                allProfiles.map((profile, i) => (
                    <div
                        class="participating-influencer-preview pointer"
                        onClick={() => {
                            setActiveProfile(profile);
                            setInviteByEmailModalVisible(true);
                        }}
                    >
                        <div class="profile-image-container">
                            <img src={profile.profile_pic_url} class="profile-image" />
                        </div>
            ...
            {inviteByEmailModalVisible && (
                <InviteByEmail
                    inviteByEmailModalVisible={inviteByEmailModalVisible}
                    setInviteByEmailModalVisible={setInviteByEmailModalVisible}
