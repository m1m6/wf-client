	...
	return (
		<div className="discover-wrapper">
			<div className="discover-filters-wrapper">
				<React.Fragment>
					<CommonFilter filterName="followers" filterKey={FILTER_KEYS.followers} />
					<CommonFilter filterName="gender" filterKey={FILTER_KEYS.gender} />
					<CommonFilter filterName="category" filterKey={FILTER_KEYS.categories} />
					<CommonFilter filterName="language" filterKey={FILTER_KEYS.languages} />
					<CommonFilter filterName="country" filterKey={FILTER_KEYS.country} />
					{/* <CommonFilter filterName="city" filterKey={FILTER_KEYS.country} /> */}
					<CommonFilter filterName="size" filterKey={FILTER_KEYS.creatorsSize} />
				</React.Fragment>
			</div>
			<List />
		</div>
