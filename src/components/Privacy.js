...
const Privacy = ({}) => {
    return (
        <div style={{marginLeft: '8%', marginTop: '20px', marginRight: '8%'}}>
            <h1>Privacy Policy for BrandInfluencers.me</h1>

            <p>
                At BrandInfluencers, accessible from BrandInfluencers.me, one of our main priorities
                is the privacy of our visitors. This Privacy Policy document contains types of
                information that is collected and recorded by BrandInfluencers and how we use it.
            </p>
            ...
            <p>
                ...
                BrandInfluencers. This policy is not applicable to any information collected offline
            ...
            <p>
                BrandInfluencers follows a standard procedure of using log files. These files log
                ...
                <a href="https://www.privacypolicygenerator.info">Privacy Policy Generator</a> and
                the <a href="https://www.disclaimergenerator.org/">Disclaimer Generator</a>.
            </p>
            ...
            <p>
                ...
                on BrandInfluencers, which are sent directly to users' browser. They automatically
            ...
            <p>
                Note that BrandInfluencers has no access to or control over these cookies that are
            ...
            <p>
                BrandInfluencers's Privacy Policy does not apply to other advertisers or websites.
            ...
            <p>
                BrandInfluencers does not knowingly collect any Personal Identifiable Information
