...
const Disclaimer = ({}) => {
    return (
        <div style={{ marginLeft: '8%', marginTop: '20px', marginRight: '8%' }}>
            <h1>Disclaimer for brandinfluencers.me</h1>

            <p>
                If you require any more information or have any questions about our site's
                disclaimer, please feel free to contact us by email at omarmahmmoud@gmail.com
            </p>

            <h2>Disclaimers for brandinfluencers.me</h2>

            <p>
                All the information on this website - https://www.brandinfluencers.me/ - is
                published in good faith and for general information purpose only.
                brandinfluencers.me does not make any warranties about the completeness, reliability
                and accuracy of this information. Any action you take upon the information you find
                on this website (brandinfluencers.me), is strictly at your own risk.
                brandinfluencers.me will not be liable for any losses and/or damages in connection
                with the use of our website. Our Disclaimer was generated with the help of the{' '}
